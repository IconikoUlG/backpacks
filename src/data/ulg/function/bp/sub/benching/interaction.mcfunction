...
execute if data entity @s ArmorItems[3].components."minecraft:custom_data".bp.dirty run data modify storage ulg:macro table_modify.isVirgin set value false
