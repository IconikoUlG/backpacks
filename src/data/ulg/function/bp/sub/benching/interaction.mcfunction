...
data modify storage ulg:macro table_modify.currentModel set from entity @s equipment.head.components."minecraft:item_model"
if data entity @s equipment.head.components."minecraft:custom_data".bp.dirty run data modify storage ulg:macro table_modify.isVirgin set value false
