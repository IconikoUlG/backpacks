...
$if data storage ulg:macro tick.modify.c_layer{accepts:["$(itemGroupId)"]} run function ulg:bp/sub/benching/modify/m_step2r_sub with storage ulg:macro table_modify_s2
