...
execute if data storage ulg:macro prepare_slot_x.item.components."minecraft:custom_name" run return run function ulg:backpack/sub/set_lore/prepare_slot_x/cnc_set with storage ulg:macro prepare_slot_x.packet
...
execute unless score @s ulg_intick1 matches 0 run return run function ulg:backpack/sub/set_lore/prepare_slot_x/modded_case

function ulg:backpack/sub/set_lore/prepare_slot_x/default_case